...
<!--          size="mini"-->
<!--          @click="handleAdd"-->
<!--          v-hasPermi="['laboratory:points:add']"-->
<!--        >新增</el-button>-->
<!--      </el-col>-->
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['laboratory:points:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['laboratory:points:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['laboratory:points:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listPoints, getPoints, delPoints, addPoints, updatePoints } from "@/api/laboratory/points";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('laboratory/points/export', {
        ...this.queryParams
